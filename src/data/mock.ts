...
/** 料金・プラン内容改定（2026-08-03）。本番反映には microCMS 同期が必要 */
...
export const mockPlans: Plan[] = [
  {
    ...
    siteType: "通常サイト",
    price: "70,000円〜",
    priceNote: "まずは小さくWebサイトを持ちたい方向けの小規模制作プランです。",
    shortDescription: "1〜2ページ程度で、お店やサービスの基本情報をシンプルにまとめる制作プランです。",
    description:
      "ライトプランは、個人店・小規模事業者の方に向けた、小規模なホームページ制作プランです。\nお店やサービスの紹介、アクセス、SNSリンク、お問い合わせ導線など、必要な情報をシンプルに整理して掲載します。\nまずは小さくWebサイトを持ちたい方や、SNS・Googleマップから飛ばす公式ページが欲しい方におすすめです。",
    recommendedFor: [
      "まずは小さくWebサイトを持ちたい方",
      "SNSやGoogleマップから飛ばす公式ページが欲しい方",
      "1ページで事業内容や店舗情報をまとめたい方",
    ],
    publishableContent: [
      "お店・サービス紹介",
      "コンセプト・想い",
  ...
  },
  {
    ...
    siteType: "通常サイト",
    price: "150,000円〜",
    priceNote: "店舗やサービスの公式サイトを、複数ページでしっかり整える標準プランです。",
    shortDescription: "3〜5ページ程度で、トップ・サービス・料金・店舗情報・お問い合わせなどを整理する制作プランです。",
    description:
      "スタンダードプランは、店舗やサービスの情報を複数ページに分けて整理する、標準的なホームページ制作プランです。\nトップページ、サービス紹介、料金、アクセス、お問い合わせなど、見る人が必要な情報にたどり着きやすい構成で制作します。\n小規模事業として、きちんと見えるWebサイトが欲しい方におすすめです。\n※CMS更新機能や本格的な予約・注文フォームはオプションです。",
    recommendedFor: [
      "店舗やサービスの公式サイトを作りたい方",
      "トップページ、サービス紹介、料金、店舗情報、お問い合わせなどを整理したい方",
      "小規模事業として、きちんと見えるWebサイトが欲しい方",
    ],
    publishableContent: [
      "トップページ",
      "サービス・メニュー紹介",
  ...
  },
  {
    ...
    siteType: "通常サイト",
    price: "270,000円〜",
    priceNote: "世界観や雰囲気まで丁寧に作り込む、上位の制作プランです。",
    shortDescription: "6〜10ページ程度で、ビジュアルや導線まで丁寧に設計する本格制作プランです。",
    description:
      "プレミアムプランは、ブランドやサービスの魅力を最大限に伝えるため、構成・デザイン・導線まで丁寧に設計する上位プランです。\n飲食店、美容室、和菓子店、旅館、店舗ブランドなど、世界観や雰囲気までしっかり見せたい方におすすめです。\nメニュー、商品、採用、予約導線ページなどにも対応します。既存サイトのリニューアルにも向いています。\n※CMS更新機能やオンライン決済・会員機能はオプション／対象外です。",
    recommendedFor: [
      "飲食店、美容室、和菓子店、旅館、店舗ブランドなど",
      "世界観や雰囲気までしっかり見せたい方",
      "メニュー、商品、採用、予約導線まで作り込みたい方",
      "既存サイトのリニューアルをしたい方",
    ],
    publishableContent: [
      "トップページ",
  ...
  },
  {
    ...
    siteType: "ミニ制作",
    price: "10,000円〜",
    priceNote: "SNSプロフィールに貼るリンクまとめページです。内容によって料金は変動します。",
    shortDescription: "Instagram、TikTok、X、YouTube、公式サイト、予約リンクなどを1ページに整理するプランです。",
    description:
      "プロフィールリンクページは、SNSプロフィールに貼るリンクまとめページです。\nInstagram、TikTok、X、YouTube、公式サイト、予約リンクなどを1ページに整理します。\nまずは小さく始めたい方にも相談しやすい入口プランです。",
    recommendedFor: [
      "SNSから各リンクへ誘導したい方",
      "活動やサービスを1ページにまとめたい方",
    ...
    pageCount:
      "1ページ\n内容やページ量によって料金は変動します。写真・文章・掲載内容が多い場合は別途お見積もりとなります。",
    clientProvides: [
      "プロフィール画像",
      "背景画像",
      "掲載したい名前・肩書き",
  ...
  },
  {
    ...
    siteType: "ミニ制作",
    price: "25,000円〜",
    priceNote: "個人事業主・フリーランス・小規模店舗向けの簡易ホームページです。",
    shortDescription: "自己紹介、サービス内容、連絡先、SNS導線などを掲載するWeb名刺プランです。",
    description:
      "Web名刺プランは、個人事業主・フリーランス・小規模店舗向けの簡易ホームページです。\n自己紹介、サービス内容、連絡先、SNS導線などを掲載します。\n名刺やSNSから飛ばせる、相談しやすい入口ページとしてご利用いただけます。",
    recommendedFor: [
      "フリーランスの方",
      "個人事業主の方",
      "店舗オーナーの方",
  ...
  },
  {
    ...
    siteType: "ミニ制作",
    price: "35,000円〜",
    priceNote: "紙や画像のメニューを、スマホで見やすいWebページに整理するプランです。",
    shortDescription: "飲食店、美容室、サロンなどに向けて、メニューをWebで見やすくまとめるプランです。",
    description:
      "メニューWeb化プランは、紙や画像のメニューを、スマホで見やすいWebページに整理するプランです。\n飲食店、美容室、サロンなどに向けた内容です。\n商品数・メニュー数が多い場合は別途お見積もりとなります。",
    recommendedFor: [
    ...
    pageCount:
      "1〜2ページ程度\n内容やページ量によって料金は変動します。商品数・メニュー数が多い場合は別途お見積もりとなります。",
    clientProvides: [
      "現在使用しているメニュー表",
      "メニュー名・価格・説明文",
      "メニュー写真",
    ...
    notes: [
      "表示価格は目安です。内容やページ量によって料金は変動します。",
      "写真・文章・掲載内容が多い場合は別途お見積もりとなります。商品数・メニュー数が多い場合も別途お見積もりです。",
      "CMS・予約フォーム・決済機能などはオプションです。内容に応じてお見積もりします。",
      "ドメイン・サーバー費用、外部サービス利用料は別途です。",
  ...
  },
  {
    ...
    siteType: "ミニ制作",
    price: "40,000円〜",
    priceNote: "スポーツチーム、サークル、団体向けの活動紹介ページです。",
    shortDescription: "活動紹介、メンバー募集、練習場所、SNSリンク、問い合わせ導線などを掲載するプランです。",
    description:
      "チーム・団体ページは、スポーツチーム、サークル、団体向けのページです。\n活動紹介、メンバー募集、練習場所、SNSリンク、問い合わせ導線などを掲載します。\n小さく始めつつ、募集や案内に使いやすいページを作りたい方におすすめです。",
    recommendedFor: [
      "スポーツチームの方",
      "サークル・学生団体の方",
      "地域団体・コミュニティの方",
    ...
    notes: [
      ...
      "CMS・予約フォーム・決済機能などはオプションです。内容に応じてお見積もりします。",
      "ドメイン・サーバー費用、外部サービス利用料は別途です。",
      "代表者・スタッフ紹介は必要な場合のみ掲載します。掲載人数が多い場合は追加料金となる場合があります。",
    ],
    order: 140,
    isFeatured: false,
  ...
  },
  {
    ...
    siteType: "ミニ制作",
    price: "50,000円〜",
    priceNote: "イベント、キャンペーン、期間限定企画、募集ページなどに使える1ページLPです。",
    shortDescription: "期間限定の告知や申込導線をまとめる、相談しやすいキャンペーンページです。",
    description:
      "期間限定キャンペーンページは、イベント、キャンペーン、期間限定企画、募集ページなどに使える1ページLPです。\n内容が多い場合や申込フォームが必要な場合は別途お見積もりとなります。\nSNSやチラシから案内できるページを、短期間で用意したい方におすすめです。",
    recommendedFor: [
      "期間限定キャンペーンを告知したい方",
      "セールや特典の案内ページが欲しい方",
      "イベント・体験会の申込ページが欲しい方",
    ...
    pageCount:
      "1ページ\n内容やページ量によって料金は変動します。内容が多い場合や申込フォームが必要な場合は別途お見積もりとなります。",
    clientProvides: [
      "キャンペーン内容",
      "開催期間・日時",
      "料金・特典内容",
    ...
    notes: [
      "表示価格は目安です。内容やページ量によって料金は変動します。",
      "写真・文章・掲載内容が多い場合は別途お見積もりとなります。申込フォームが必要な場合も別途お見積もりです。",
      "CMS・予約フォーム・決済機能などはオプションです。内容に応じてお見積もりします。",
      "ドメイン・サーバー費用、外部サービス利用料は別途です。",

...
export const staticFaqs: Faq[] = [
  {
    ...
    answer:
      'もちろん大丈夫です。\n事業内容やご希望をお聞きしたうえで、必要なページ構成やプランの目安をご提案します。無理な営業は一切ありません。',
    category: 'contact',
    sortOrder: 1,
    isVisible: true,
    isFeatured: true,
  },
  {
    ...
    answer:
      '本格制作プランはお店や事業のしっかりとしたサイト制作向けです。\nミニプランは名刺代わりの1ページやメニュー掲載など、小さく始めたい方向けのコンパクトなプランです。',
    category: 'normal',
    sortOrder: 2,
    isVisible: true,
    isFeatured: true,
  ...
  },
  {
    ...
    answer:
      'はい、可能です。お持ちの素材を活かしながら、必要な情報の整理や文章のたたき台づくりもお手伝いします。\n別途費用が発生する場合は事前にご相談ください。',
    category: 'normal',
    sortOrder: 6,
    isVisible: true,
    isFeatured: false,
  },
  {
    ...
    answer:
      'はい。ミニプランもスマホで見やすい設計を基本としています。\nただし公開作業やサーバー・ドメイン設定は含まれない点にご注意ください。',
    category: 'mini',
    sortOrder: 7,
    isVisible: true,
    isFeatured: false,
  ...
  },
  {
    ...
    answer:
      'プランごとに修正回数の目安を設けています。\n文言の調整やレイアウトの微修正など、範囲内で対応いたします。大幅な構成変更は別途ご相談となります。',
    category: 'delivery',
    sortOrder: 11,
    isVisible: true,
    isFeatured: false,
  },
  {
    ...
    answer:
      '本格制作プランでは公開作業のサポートが可能です。\nミニプランはファイル納品が基本ですが、別途ご相談いただければ対応できる場合があります。',
    category: 'delivery',
    sortOrder: 12,
    isVisible: true,
    isFeatured: false,
